...
\begin{thm}[Hitchin]
  ...
  \end{equation*}
  where $\BB$ is a complex vector space of complex dimension $k$, such that generic fibres of it are open sets in some submanifolds which are diffeomorphic to tori $\CC^k/\TT^{2k}$ and the canonical symplectic form of $T^*\Bun(n,d)$ vanishes on them.
\end{thm}
