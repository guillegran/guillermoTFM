...
p^*L	  \arrow{rr}\arrow{dd} && L\arrow{dd}[anchor=west]{p} \\ 
	 ...
	 \end{equation*}
       ...
       \begin{equation*}
	 \left\{ (x,\lambda) \in X\times \CC : \lambda^n + \sum_{i=1}^n b_i \lambda^{n-i} =0 \right\}.
       \end{equation*}
       ...
       \begin{equation*}
	 \left\{ (x,\lambda) \in X\times \CC: \det(\lambda \id - \varphi)=0 \right\}
       \end{equation*}
