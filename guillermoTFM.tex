...
The spectral curve and the associated spectral correspondence was generalized to pairs $(E,\varphi)$, where $\varphi:E\rightarrow E \otimes L$ is an endomorphism twisted by any line bundle $L$ in 1989 by Beauville, Narasimhan and Ramanan in \cite{bnr}. A GIT construction of the moduli space of stable pairs $(E,\varphi)$ of this kind was given by Nitsure in 1991 \cite{nitsure}.

In 1992 Simpson \cite{Simpson} generalized the notion of Higgs bundle (in fact, the term ``Higgs bundle'' was introduced by him, Hitchin just talked about ``the Higgs field'') to the context of higher dimensional Kähler manifolds. He also proved a generalization of the Narasimhan-Seshadri theorem and of Hitchin's correspondence known as the \textit{Nonabelian Hodge theorem} \cite{simpsonnonabelian}, that identifies the moduli space of stable $G$-Higgs bundles over a Riemann surface $X$ with the $G$-character variety of $\pi_1(X)$. The reason for this name is that an easy consequence of Hodge theorem is a correspondence between the Jacobian of $X$ and $\Hom(\pi_1(X),\UU(1))$.
